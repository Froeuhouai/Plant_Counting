...
path_input_raw = path_input_root+"/Data/Labelled/Set{0}/GrowthStage_0/RGB".format(_set)
path_input_OTSU = path_input_root+"/Output_General/Set{1}/Output/Session_{0}/Otsu_R".format(session_number, _set)
path_input_PLANT_FT_PRED = path_input_root+"/Output_General/Set{1}/Output_FA/Session_{0}/Plant_FT_Predictions".format(session_number, _set)
...
if (labelled_image):
    path_input_adjusted_position_files = path_input_root+"/Output_General/Set{1}/Output/Session_{0}/Adjusted_Position_Files".format(session_number, _set)
...
path_output_follow = path_input_root+\
                    "/Output_General/Set{4}/Output_Meta_Simulation/Session_{3}/Simu_Steps_Pictures/{1}_{2}/Img_{0}".format(
                            _image_index, RAs_group_size, RAs_group_steps, session_number, _set)
...
MAS_Simulation = Simulation_MAS(data_input_raw[_image_index],
